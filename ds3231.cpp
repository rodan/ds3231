...
void DS3231::init(const uint8_t creg)
{
  set_creg(ctrl_reg);
}

void DS3231::set(struct ts t)
{
    uint8_t i, century;
...
void DS3231::set_creg(const uint8_t val)
{
...
void DS3231::set_sreg(const uint8_t val)
{
    set_addr(DS3231_STATUS_ADDR, val);
}

uint8_t DS3231::get_sreg(void)
{
    uint8_t rv;
...
void DS3231::set_aging(const int8_t val)
{
    uint8_t reg;
...
void DS3231::clear_a1f(void)
{
    ...
    reg_val = get_sreg() & ~DS3231_A1F;
    set_sreg(reg_val);
}

uint8_t DS3231::triggered_a1(void)
{
    return  get_sreg() & DS3231_A1F;
}
...
void DS3231::clear_a2f(void)
{
    ...
    reg_val = get_sreg() & ~DS3231_A2F;
    set_sreg(reg_val);
}

uint8_t DS3231::triggered_a2(void)
{
    return  get_sreg() & DS3231_A2F;
}
